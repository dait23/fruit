...
const Help = inject('helpStore')(
  observer(
    class extends Component {
      render() {
        const { error, loading, privacy } = this.props.helpStore;
        const createTime= privacy.createdAt
         const updatedTime= privacy.updateddAt
        ...
        <MetaTags>
            ...
            <meta property="og:image" content={privacy.imageUrl} />
        </MetaTags>
            ...
            <div className="col-md-2"></div>
                <div className="col-md-8">
                     ...
                     <div className="post-content">
                        <h1 className="posttitle">Nomadic - Privacy Policy.</h1>
                       ...
                       <div className="col-md-1"  style={{marginLeft:'-10px'}}><img src="https://res.cloudinary.com/nomadic-id/image/upload/v1522390682/logo_google.jpg" alt="logo avatar" className="img-circle"/></div>
                        <div className="col-md-5 col-sm-12">
                          ...
                          <p className="author-info">Publishing Platform for everyone. <br /><span  style={{color:'#baba',fontSize:'11px' }}>{createDT} - {privacy.reading} min read</span></p>
                        </div>
