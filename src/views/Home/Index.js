...
const Help = inject('helpStore')(
  observer(
    class extends Component {
      render() {
        const { error, loading, about } = this.props.helpStore;
         const createTime= about.createdAt
         const updatedTime= about.updateddAt
		      ...
		      <div className="row">
                ...
                <div className="col-md-8">
                     ...
                     <div className="post-content">
                        <h1 className="posttitle">Selamat datang di Nomadic, Publishing Platform untuk semua orang.</h1>
	                        <div className="post-author-info-top">
				               <div className="col-md-1"  style={{marginLeft:'-10px'}}><img src="https://res.cloudinary.com/nomadic-id/image/upload/v1522390682/logo_google.jpg" alt="logo avatar" className="img-circle"/></div>
				                <div className="col-md-5 col-sm-12">
				                  ...
				                  <p className="author-info">Publishing Platform for everyone. <br /><span  style={{color:'#baba',fontSize:'11px' }}>{createDT} - {about.reading} min read</span></p>
				                </div>
                        ...
                        <Image cloudName={Cloudinary_Name} publicId={about.imageId}  crop="scale"  alt={about.title}/>
